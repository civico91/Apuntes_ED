...
Windows y Linux están desarrollados en C.
...
Estos son los elementos basicos de un computador. Los programas tambien se quedan guardados en archivos.

La CPU tiene que leer a través de la memoria RAM, no puede leer directamente del disco duro. Y en la zona memoria lee de instrucción a instrucción.
...
El ciclo de vida empieza cuando piensas en hacer una aplicación. Luego la creas, la desarrollas y ya hasta que alguien deje de usar dicha aplicación y se queda obsoleta y deja de usarse.
...
![Modelo en V](img/modelo_en_v.png)
...
(Dichas reuniones se hacen mucho para hablar sobre el programa que estan desarrollado, suelen ser cortas y mayormente de pie para no apalancarse. Se les hacen 3 preguntas al trabajador: ¿Ha tenido algun problema? ¿Que llevas hecho? ¿Que mas te queda por hacer?)
...
- Simplicidad: Hacer el código lo más simple posible.
- Comunicación: La comunicación entre programador y cliente.
- Retroalimentación: Ver como marcha el proyecto.
- Valentía o coraje: Tenerla para desechar algo que has hecho por el bien del proyecto.
- Respeto o humildad: A la hora de valorar el trabajo de otro, debes valorarlo todos por igual.
...
- Diseño sencillo: Mejorar la calidad del código en cuanto a presentación. Mas sencillo, mas simplificado..
- Pequeñas mejoras continuas: Ver resultados de como avanza la aplicación. Usarla y probarla.
- Pruebas y refactorización
- Integración continua
- __Programación por parejas__ :puede parecer poco productivo, pero puede mejorar en cuanto a calidad. No es algo permanente, puedes programar con una pareja por la mañana y con otra por la tarde.
- __El cliente se integra en el equipo de desarrollo__ : El representante de la empresa está en el equipo se desarrolla viendo como se hace y los errores posibles o lo que no le gusta.
- Propiedad del código compartida
- Estándares de codificación
- 40 horas semanales: Se procura que los programadores esten descansados, ya que es un trabajo de calidad.
...
- Para obtener código binario ejecutable tenemos 2 opciones:
  - __Compilar__ Se genera un archivo ejecutable
  - __Interpretar__ No se genera un archivo ejecutable


### Proceso de compilación/interpretación

- La compilación/interpretación del código fuente se lleva a cabo en dos fases:
  1. __Análisis léxico__ equivalente a comprobar ortografía.
  2. __Análisis sintáctico__ comprueban el orden de las palabras y signos de puntuación (tokens - los tokens son palabras claves, llaves, punto y coma...).
  3. __Análisis semántico___ 
...
Si en java, se le da un valor 0 a algo, se dice que es un valor falso y no habria ejecución.
...
Lenguaje de los que mas se utilizan actualmente.

- Ventajas:
  - Estructurado y Orientado a Objetos
  - Relativamente fácil de aprender
  - Buena documentación y base de usuarios amplia.
- Desventajas:
  - Menos eficiente que los lenguajes compilados. Aprovecha menos los recursos del ordenador. La ejecución es algo mas lenta.
...
- Tipos de __lenguajes declarativos__: (Mayormente se usan poco, salvo SQL)
...
- Muchos de estos lenguajes son compilados. C y C++ son compilados. Java es medio compilado.
...
- Campo de aplicación -> tipo de programa que se va a desarrollar.
- Experiencia previa
- Herramientas de desarrollo -> Buenos Ide, buenos compiladores.
